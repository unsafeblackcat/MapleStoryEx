...
{
	//破功
	Memory::WriteDouble(0x00AFE8A0, dDamage);	//物攻
	//Memory::WriteDouble(0x00AFE8A2, dDamage);	//魔攻   感谢大仙
	int setDamageCapInt = static_cast<int>(dDamage < 0 ? dDamage - 0.5 : dDamage + 0.5);
	//Memory::WriteInt(0x008C3304 + 1, setDamageCapInt); //面板破功
	//Memory::WriteInt(0x0077e056, setDamageCapInt); //面板属性破上限   感谢大仙
	//Memory::WriteInt(0x0077e130, setDamageCapInt); //面板属性破上限   感谢大仙
	//Memory::WriteInt(0x0077e216, setDamageCapInt); //面板属性破上限   感谢大仙
	//Memory::WriteInt(0x00780621, setDamageCapInt); //面板属性破上限   感谢大仙
	//Memory::WriteInt(0x007806d1, setDamageCapInt); //面板属性破上限   感谢大仙 
	//Memory::WriteInt(0x00780703, setDamageCapInt); //面板属性破上限   感谢大仙
...
{
	//键盘
	Memory::WriteInt(dwQuickSlotInitVPos + 1, 720 /2);//720
	Memory::WriteInt(dwQuickSlotInitHPos + 1, 1280/2); //890
	Memory::WriteInt(dwQuickSlotVPos + 2, 720 /2 );//720
	Memory::WriteInt(dwQuickSlotHPos + 1, 1280 / 2);//890

	//Memory::WriteInt(0x008DE897, 1280/2);
	//Memory::WriteInt(0x008DE8AC, 720/2);
	//Memory::WriteInt(0x0089b63a, 1280 / 2);
	//Memory::WriteInt(0x0089b6f8, 720 / 2);
	//Memory::WriteInt(0x0089b797, 1280 / 2);
	//Memory::WriteInt(0x0089ba04, 720 / 2);
